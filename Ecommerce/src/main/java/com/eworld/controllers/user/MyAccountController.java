...
public class MyAccountController {
	...
	public String showProfile(Model model, Principal principal, HttpSession session) {
		model.addAttribute("title", "Account Dashboard - " + appName);
	...
	public String accountOrders(Principal principal, Model model) {
		model.addAttribute("title", "Your Orders - " + appName);
	...
	public String accountProfile(Model model) {
		...
		model.addAttribute("title", "Account Profile - " + appName);
	...
	public String accountEditProfile(Model model) {
		...
		model.addAttribute("title", "Edit Account Profile - " + appName);
	...
	public String savedAddress(Model model) {
		model.addAttribute("title", "Account Addresses - " + appName);
		model.addAttribute("address", new Address());
	...
	public String addAddress(@Valid @ModelAttribute("address") Address address, BindingResult result, Model model,
		...
		model.addAttribute("title", "Add Account Address - " + appName);
	...
	public String deleteAddress(@PathVariable("addressId") String addressId, Model model, HttpSession session,
			Principal principal) {
		model.addAttribute("title", "Delete Account Address - " + appName);
	...
	public String wishlist(Model model) {
		model.addAttribute("title", "Account Wishlist - " + appName);
		model.addAttribute("pageName", "Wishlist");
		return "user/account/wishlist";
	}

	@GetMapping("/add-to-wishlist/{productId}")
	public String addToWishlist(@PathVariable("productId") String productId, Principal principal, Model model,
			HttpSession session) {
		model.addAttribute("title", "Add Wishlist - " + appName);
		try {
	...
	public String moveToCart(@PathVariable("wishlistItemId") String wishlistItemId, Principal principal, Model model,
			HttpSession session) {
		model.addAttribute("title", "Move To Cart - " + appName);
		try {
	...
	public String removeFromWishlist(@PathVariable("wishlistItemId") String wishlistItemId, Principal principal,
		...
		model.addAttribute("title", "Remove Wishlist - " + appName);
		try {
	...
	public String changePasswordProcess(@RequestParam("oldPassword") String oldPassword,
		...
		model.addAttribute("title", "Change Account Password - " + appName);
