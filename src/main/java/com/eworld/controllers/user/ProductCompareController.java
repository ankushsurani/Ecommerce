...
public class ProductCompareController {
	...
	private String compareProduct(Principal principal, Model model) {
		model.addAttribute("title", "Product Compare - " + appName);
	...
	private String addCompareProduct(@PathVariable("productId") String productId, Principal principal, Model model,
			HttpSession session) {
		model.addAttribute("title", "Add Product Compare - " + appName);
	...
	private String removeProductFromComparison(@PathVariable("productCompareItemId") String productCompareItemId,
		...
		model.addAttribute("title", "Remove Product Compare - " + appName);
