...
public class MyProfileController {
	...
	public String addAddress(@Valid @ModelAttribute("address") Address address, BindingResult result, Model model, Principal principal, HttpSession session, @RequestParam(name = "paymentpage",required = false) String paymentPage) {
	...
	public String editAddress(@PathVariable("addressId") int addressId, Model model, Principal principal, HttpSession session) {
	...
	//update user mobile number details
		...
		public String updateNumber(@Valid @ModelAttribute("user") User user, BindingResult result, Model model, HttpSession session) {
			model.addAttribute("title", "Update Profile - Eworld");
	...
	//change user password 
		...
		public String changePassword(@PathVariable("userId") int userId, Model model, HttpSession session) {
			model.addAttribute("title", "Change Password - Eworld");
	...
	//change password process
		...
		public String changePasswordProcess(@RequestParam("oldPassword") String oldPassword,
											...
											@RequestParam("sendedOtp") int sendedOtp,
